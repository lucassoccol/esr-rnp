...
Reconfigure o DNS _system-wide_. Devido ao DHCP, torne o arquivo `/etc/resolv.conf` imutável.
...
# ls -1 Kintnet.+007+*
Kintnet.+007+04740.key
Kintnet.+007+04740.private
Kintnet.+007+12293.key
Kintnet.+007+12293.private
...
=== 5) Automatizando assinatura DNSSEC após alterações

[source,bash,linenums]
----
include::{srcdir}/s2/etc_nsd_signzone-intnet.sh[]
----
