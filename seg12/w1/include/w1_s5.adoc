...
[source,bash]
----
include::{srcdir}/s5/sshd_failure.sh[]
----
endif::gabarito[]
...
[source,bash]
----
include::{srcdir}/s5/logtime_sum.sh[]
----
endif::gabarito[]
...
[source,bash]
----
include::{srcdir}/s5/etc_rsyslog.d_client_linux.conf[]
----
...
[source,bash]
----
include::{srcdir}/s5/etc_logrotate.d_cron[]
----
endif::gabarito[]
...
[source,bash]
----
include::{srcdir}/s5/etc_logwatch_conf_logwatch.conf[]
----
+
...
[source,bash]
----
include::{srcdir}/s5/etc_swatch.conf[]
----
+
...
[source,bash]
----
include::{srcdir}/s5/etc_systemd_system_swatch.service[]
----
+
