...
[source,bash]
----
include::{srcdir}/s13/etc_squid3_squid.conf[]
----
...
[source,bash]
----
include::{srcdir}/s13/etc_squid3_acl_mac.conf[]
----
+
...
[source,bash]
----
include::{srcdir}/s13/etc_squid3_acl_ip.conf[]
----
+
...
[source,bash]
----
include::{srcdir}/s13/etc_squid3_acl_time.conf[]
----
+
...
[source,bash]
----
include::{srcdir}/s13/etc_squid3_acl_regex_ext.conf[]
----
+
No topo do bloco `acl`:
+
...
[source,bash]
----
include::{srcdir}/s13/etc_squid3_acl_regex_word.conf[]
----
+
No topo do bloco `acl`:
+
...
[source,bash]
----
include::{srcdir}/s13/etc_squid3_acl_domain.conf[]
----
+
