...
[source,bash]
----
include::{srcdir}/s7/etc_bind_named.conf.options[]
----
+
...
[source,bash]
----
include::{srcdir}/s7/etc_bind_named.conf.local[]
----
+
...
[source,bash]
----
include::{srcdir}/s7/etc_bind_db.empresa.com.br[]
----
+
...
[source,bash]
----
include::{srcdir}/s7/etc_bind_db.0.168.192[]
----
+
...
[source,bash]
----
include::{srcdir}/s7/etc_resolv.conf[]
----
...
[source,bash]
----
include::{srcdir}/s7/sec_etc_bind_named.conf.options[]
----
+
* `/etc/bind/named.conf.local` -- configurações locais do servidor `bind`:
+
[source,bash]
----
include::{srcdir}/s7/sec_etc_bind_named.conf.local[]
----
+
...
[source,bash]
----
include::{srcdir}/s7/sec_etc_resolv.conf[]
----
