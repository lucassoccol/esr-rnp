...
[source,bash]
----
include::{srcdir}/sessao_9/at1_etc_dhcp_dhcpd.conf[]
----
...
[source,bash]
----
include::{srcdir}/sessao_9/at3_etc_dhcp_dhcpd.conf[]
----
...
[source,bash]
----
include::{srcdir}/sessao_9/etc_vsftpd.conf[]
----
...
5. Na máquina _Client_Linux_, crie um arquivo de teste para ser enviado por _upload_ para o servidor FTP. A seguir, logue no servidor e envie o arquivo:
+
.................
$ hostname
cliente
...
6. De volta à máquina _Server_Linux_, verifique que o arquivo foi enviado com sucesso.
+
.................
# hostname
servidor
...
4. A chave pública RSA foi armazenada no arquivo `/home/aluno/.ssh/id_rsa.pub`, na pasta _home_ do usuário `aluno` dentro da máquina _Server_Linux_. Vamos exibir seu conteúdo:
+
.................
$ hostname
servidor
