...
[source,bash]
----
include::{srcdir}/sessao_5/etc_rsyslog.d_client_linux.conf[]
----
...
[source,bash]
----
include::{srcdir}/sessao_5/etc_logrotate.d_cron[]
----
endif::gabarito[]
...
[source,bash]
----
include::{srcdir}/sessao_5/etc_logwatch_conf_logwatch.conf[]
----
+
...
+
.................
Aug  9 16:39:56 servidor sshd[4113]: Failed password for aluno from 192.168.0.12 port 51230 ssh2
.................
+
...
[source,bash]
----
include::{srcdir}/sessao_5/etc_swatch.conf[]
----
+
...
Aug  9 17:32:35 servidor sshd[5093]: Failed password for aluno from 192.168.0.12 port 51460 ssh2
...
[source,bash]
----
include::{srcdir}/sessao_5/etc_systemd_system_swatch.service[]
----
+
