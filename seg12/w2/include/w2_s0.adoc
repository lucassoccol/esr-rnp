...
[#img-rede-winserver]
[caption="Figura 2: "]
image::Configuracao_Rede_WinServer.png[]
+
<<<
...
[#img-rede-winclient]
[caption="Figura 3: "]
image::Configuracao_Rede_WinClient.png[]
+
<<<
...
1. Antes de mais nada, observe que na máquina _FWGW1-G_ já existe uma configuração de _masquerading_ (um tipo de SNAT que veremos em maior detalhe na sessão 4) no arquivo `/etc/rc.local`:
+
.................
# hostname
FWGW1-A
...
[caption="Figura 7: "]
image::Winserver_changename.png[]
