...
[WARNING]
====
Para tangibilizar os exemplos deste caderno/gabarito, a partir deste momento iremos assumir que o aluno é membro do grupo `A`, ou seja, tem suas máquinas virtuais nas redes 192.168.1.0/24 e 172.16.1.0/24. Se você for membro do grupo `B`, tenha o cuidado de sempre adaptar os endereços IP dos exemplos para as suas faixas de rede.
====
