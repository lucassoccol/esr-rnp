...
3. Na máquina _LinServer-G_, como usuário `root`, instale o pacote `rng-tools` e rode o comando `rngd -r /dev/urandom`:
ifdef::gabarito[]
+
....
# hostname ; whoami
...
4. Como usuário `aluno`, gere a chave de Bobby na máquina _LinServer-G_. Repita o procedimento do passo (2), alterando o nome de usuário para Bobby e o email para bobby@seg12.esr.rnp.br .
ifdef::gabarito[]
+
....
$ hostname ; whoami ; pwd
