...
As máquinas virtuais disponíveis serão exibidas na janela principal do VMware Workstation. Selecione a máquina virtual criada (VM-ADS5) e  inicie clicando em Power on this virtual machine.
+
.Iniciar VM
[#img-vbox22]
